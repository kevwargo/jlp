(defun test-fn-1 (a (b c)
  ...
  (list a b c x y rest k1 k2 other-keys))

(print (test-fn-1 1 '(2 3) :k1 333))
(print (test-fn-1 'x1 (list "asdf" "foobar") 4 5 'ok 'nope :k2 2 :k1 1 :k3 'o :key4 'p))
...
(defun test-fn-2 (a b ;positionals
  ...
  (list a b unpacked-1 unpacked-2 unp-1 unp-nested-1 unp-nested-2 opt1 opt2 rest k1 k2 all-keys))
